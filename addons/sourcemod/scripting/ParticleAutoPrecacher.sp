...
{ 
    ...
    version = "1.2.4", 
    url = "https://gitlab.com/counterstrikeglobaloffensive/sm-plugins/particleautoprecacher" 
}; 
...
{ 
    ...
    { 
        LogError("Manifest file \'%s\' not found.", sManifestFullPath); 
        return; 
    }
...
{ 
    ...
    { 
        LogError("Failed going to first key of particles_manifest"); 
        delete hKeyValue; 
        hFile.Close(); 
        return; 
    } 
...
{ 
    ...
    { 
        LogError("Particle file \'%s\' not found.", path); 
        return;
    }
